...
urlpatterns = [
    path('', translator_views.home, name='landing'),
    ...
    path('compress_simulation/', translator_views.compress_simulation_view, name='compress_simulation'),
    path('delete_simulation/', translator_views.delete_simulation_view, name='delete_simulation'),
